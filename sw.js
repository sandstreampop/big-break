...
const CACHE = 'bigbreak-v25';
const CORE = [
  './', 'index.html', 'css/style.css', 'manifest.webmanifest',
  'js/main.js', 'js/ui.js', 'js/engine.js', 'js/save.js', 'js/audio.js', 'js/composer.js',
  ...
  'js/data/hustles.js', 'js/data/assets.js', 'js/data/genres.js', 'js/data/arcs.js', 'js/data/weather.js',
