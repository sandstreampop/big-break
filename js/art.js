...
const EMOJI = {
  ...
  ev_docu_pitch: '🎬', ev_docu_moment: '🎥', ev_docu_premiere: '🍿', ev_checkhell: '🔊', ev_merchline: '🧾', ev_goldhands: '🫳', ev_blooper: '📯', ev_shed: '🛖', ev_shed_night: '🌙', ev_shed_album: '📀', ev_bloom_amp: '🔌', ev_bloom_big: '🌸', ev_summit: '🥐', ev_truce: '☕', ev_diss: '🎤', ev_venue_trouble: '📌', ev_loadout: '⏱️', ev_dc_offer: '📇', ev_dc_blizzard: '❄️', ev_dc_birthday: '🎂', ev_dc_last: '🏛️',
...
const SCENE = {
  ...
  ev_docu_pitch: 'street', ev_docu_moment: 'stage', ev_docu_premiere: 'arena', ev_checkhell: 'stage', ev_merchline: 'shop', ev_goldhands: 'street', ev_blooper: 'phone', ev_shed: 'home', ev_shed_night: 'studio', ev_shed_album: 'studio', ev_bloom_amp: 'stage', ev_bloom_big: 'arena', ev_summit: 'shop', ev_truce: 'street', ev_diss: 'phone', ev_venue_trouble: 'stage', ev_loadout: 'street', ev_dc_offer: 'office', ev_dc_blizzard: 'street', ev_dc_birthday: 'home', ev_dc_last: 'stage',
