...
const EMOJI = {
  ...
  ev_cb_remembered: '🛒', ev_cb_fest: '⏪', ev_cb_exec: '🎫',
  ...
  ev_docu_pitch: '🎬', ev_docu_moment: '🎥', ev_docu_premiere: '🍿', ev_checkhell: '🔊', ev_merchline: '🧾', ev_goldhands: '🫳', ev_blooper: '📯', ev_shed: '🛖', ev_shed_night: '🌙', ev_shed_album: '📀', ev_shed_doc: '🎦', ev_shed_someone: '🕯️', ev_bloom_fest: '🎪', ev_shed_collab: '🚗', ev_bloom_amp: '🔌', ev_coverband: '🌺', ev_flyerwar: '📎', ev_opendeck: '🎧', ev_practicewall: '🧱', ev_bloom_big: '🌸', ev_summit: '🥐', ev_truce: '☕', ev_diss: '🎤', ev_venue_trouble: '📌', ev_loadout: '⏱️', ev_camp48: '⏳', ev_placement: '🥗', ev_heir: '💇', ev_dc_offer: '📇', ev_dc_blizzard: '❄️', ev_dc_birthday: '🎂', ev_dc_last: '🏛️',
...
const SCENE = {
  ...
  ev_cb_remembered: 'street', ev_cb_fest: 'festival', ev_cb_exec: 'office',
  ...
  ev_docu_pitch: 'street', ev_docu_moment: 'stage', ev_docu_premiere: 'arena', ev_checkhell: 'stage', ev_merchline: 'shop', ev_goldhands: 'street', ev_blooper: 'phone', ev_shed: 'home', ev_shed_night: 'studio', ev_shed_album: 'studio', ev_shed_doc: 'studio', ev_shed_someone: 'home', ev_bloom_fest: 'festival', ev_shed_collab: 'home', ev_bloom_amp: 'stage', ev_coverband: 'stage', ev_flyerwar: 'street', ev_opendeck: 'stage', ev_practicewall: 'home', ev_bloom_big: 'arena', ev_summit: 'shop', ev_truce: 'street', ev_diss: 'phone', ev_venue_trouble: 'stage', ev_loadout: 'street', ev_camp48: 'studio', ev_placement: 'office', ev_heir: 'studio', ev_dc_offer: 'office', ev_dc_blizzard: 'street', ev_dc_birthday: 'home', ev_dc_last: 'stage',
