...
export const TUTORIAL_EVENTS: GameEvent[] = [
  {
    ...
    recap: 'First gig, load-in at the Rubber Room. How does the gear get in?',
    tags: ['live'],
  ...
  },
  {
    ...
    recap: 'Ninety seconds of soundcheck and one favor to spend.',
    tags: ['live'],
  ...
  },
  {
    ...
    recap: 'Three songs: two you know cold, one written at 4 a.m.',
    tags: ['live'],
  ...
  },
  {
    ...
    recap: 'Row two’s hobbyist reviewer yells something almost supportive.',
    tags: ['live'],
  ...
  },
  {
    ...
    recap: 'Twenty minutes in the “green room” hallway. A couch and free espresso.',
    tags: ['rest'],
  ...
  },
  {
    ...
    recap: 'The opener quit via haiku. Dee offers you their slot too.',
    tags: ['live'],
  ...
  },
  {
    ...
    recap: '“Closer’s choice,” and there’s a label scout in the back.',
    tags: ['live'],
  ...
  },
  {
    ...
    recap: 'Dee pays out from an envelope labeled ENVELOPE.',
    tags: ['deal'],
  ...
  },
  {
    ...
    recap: 'The room doubled and nobody left. One more song.',
    tags: ['live'],
