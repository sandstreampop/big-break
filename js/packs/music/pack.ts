...
import { seedsPlugin } from './plugins/seeds.js';
import { musicPresenter } from './presenter.js';
import { MUSIC_PERKS } from './perks.js';
...
export const musicPack: Pack = {
  ...
  plugins: [venuePlugin, rivalPlugin, seedsPlugin, contractPlugin, weatherPlugin, genrePlugin, loadoutPlugin, gearPlugin, hustlePlugin, bandPlugin, songsPlugin, economyPlugin],
  events: EVENTS,
