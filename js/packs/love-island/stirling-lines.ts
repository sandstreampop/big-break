...
export const REACT_INCREDIBLE: BarkDef[] = [
  ...
  { id: 'ri_aimfor', text: 'They’ll show next year’s lot that as the thing to aim for and never reach.' },
...
export const REACT_TAGGED: Record<string, { incredible: BarkDef[]; bad: BarkDef[] }> = {
  ...
  drama: {
    incredible: [
      ...
      { id: 'td_masterclass', text: 'A masterclass. In what, the courts will decide. But a masterclass.' },
    ],
    bad: [
  ...
  challenge: {
    ...
    bad: [
      ...
      { id: 'tc_alibi', text: 'Came last and blamed the foam. The foam has an alibi and witnesses.' },
  ...
  strategy: {
    incredible: [
      ...
      { id: 'ts_behind', text: 'Three moves ahead and pretending to be two behind. That’s the good stuff.' },
...
export const BEAT_REACT: Record<string, BarkDef[]> = {
  ...
  bombshell: [
    ...
    { id: 'bb_teatime', text: 'A bombshell at teatime. The villa smells of SPF and quiet panic. Lovely. More of that.', priority: 10 },
  ],
  secret: [
...
export const TUTOR: Record<string, BarkDef[]> = {
  ...
  wobble: [{ id: 'tu_wobble', text: 'See the spiral up top, babes? That’s your head. Top it out and you walk — no envelope, no slow-mo montage. Rest is a move. The pros nap.', priority: 10 },
    { id: 'tu_wobble2', text: 'That climbing meter up top is your head. Let it max out and you walk yourself home — no ceremony, no montage. Resting is a legal move. Use it.', priority: 10 }],
  temptation: [{ id: 'tu_tempt', text: 'A word for the new viewers: a head-turn dents the Connection, it doesn’t break the couple. Officially. The duvets keep their own records.', priority: 10 },
    { id: 'tu_tempt2', text: 'For the new lot: a head-turn dents the Connection, it doesn’t end the couple. Officially. The duvets, mind, keep their own paperwork.', priority: 10 }],
  lineup_bondSafe: [{ id: 'tu_line_bond', text: 'Recoupling rules, quickly: the Connection keeps you, or the nation does. Tonight your Connection’s doing the heavy lifting — as it should.', priority: 10 },
    { id: 'tu_line_bond2', text: 'Recoupling, quickly: Connection or nation, one keeps you in. Tonight the Connection’s pulling the weight — exactly as it’s meant to.', priority: 10 }],
  lineup_publicSafe: [{ id: 'tu_line_public', text: 'Recoupling rules, quickly: Connection or nation, either keeps you in. Tonight, babes, it’s the nation carrying you. Wave.', priority: 10 },
    { id: 'tu_line_public2', text: 'Recoupling, quickly: two things can save you, Connection or nation. Tonight it’s the sofas doing the carrying. Give them a wave.', priority: 10 }],
  lineup_danger: [{ id: 'tu_line_danger', text: 'Recoupling rules, quickly: the Connection holds you or the nation saves you. Tonight neither is promising. I’d stand near the fire — it’s warmer.', priority: 10 },
    { id: 'tu_line_danger2', text: 'Recoupling, quickly: Connection holds you or the nation saves you. Tonight neither looks keen. Stand near the fire — warmer there, pal.', priority: 10 }],
