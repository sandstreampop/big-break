...
export const LI_TUTORIAL_EVENTS: GameEvent[] = [
  {
    ...
    recap: 'Day one, minute one — eleven strangers and a mug that says VILLA VIBES.',
    tags: ['chat'],
  ...
  },
  {
    ...
    recap: 'Got a text: tonight’s welcome-party toast, and the phone’s in your hand.',
    tags: ['text'],
  ...
  },
  {
    ...
    recap: 'First night at the firepit — a girl’s already crying over a boy.',
    tags: ['chat'],
