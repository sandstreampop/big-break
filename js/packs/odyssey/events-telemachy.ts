...
export const TELEMACHY_EVENTS: GameEvent[] = [
  ...
  sea('ody_tel_swineherd_door', 3, {
    ...
    left: {
      ...
      incredible: 'You bless it, and then you READ it, friends, like a pilot reads water: the swineherd’s door means the boy trusts the old loyalties and none of the new; dusk means he numbers the suitors’ eyes; the beggar’s hood means he has already thought the thought his father took ten years to earn — that a king comes home strongest UNDER his kingliness, not in it. You know, now, exactly what shape the house’s war will take, and who planned it before you landed. That night you sleep a whole watch through — the first since Troy that somebody else stood it.',
    },
    right: {
