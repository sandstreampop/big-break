...
export const ODYSSEY_HELP_BLOCKS: string[] = [
  ...
  '🔱 <b>Poseidon</b> is the sea’s ledger: provoke it (a name shouted, a rite skipped) and it fills. <b>At ten, the wave.</b> 🦉 <b>Athena</b> is earned by rites and cunning — and <b>past four, her favor rides every roll</b>: the owl’s edge is how the legendary outcomes come within reach. 🌟 <b>Renown</b> is deeds of legend, tallied as performed; the Glory road is paved with it.',
