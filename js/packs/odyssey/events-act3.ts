...
export const ACT3_EVENTS: GameEvent[] = [
  sea('ody_a3_wax', 3, {
    ...
    right: {
      ...
      incredible: 'Wax for all — and for yourself as well, friends, which is the verse nobody expects: the captain who declines the famous temptation entirely, who looks at the one glory no man has claimed and decides his men need a HELMSMAN more than a hero. The fleet threads the water like a needle threading silence. The singers, they say, stopped mid-verse — nothing had ever ignored them before. Being ignored, friends, is the one song they do not know.',
    },
  }),
  sea('ody_a3_strait', 3, {
    tags: ['deep', 'blood'],
  ...
  sea('ody_a3_hall_watch', 3, {
    ...
    left: {
      ...
      incredible: 'You mark the doors, the blades, the sixteen paces — and then, friends, the finer grain that turns slaughter into surgery: WHICH suitors check the exits (dangerous), which drink with both hands (not), which servant girls carry warnings to whose bed, and the one young suitor — there is always one — whose face says he knows the whole enterprise is cursed and wants only a way out. You will offer him that way, when the day comes, and he will not take it, and that, friends, is the one death in the hall the tale itself regrets. But the map you draw tonight spares three of the loyal. Maps are mercy, drawn right.',
    },
    right: {
