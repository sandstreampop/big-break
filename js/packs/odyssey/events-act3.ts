...
export const ACT3_EVENTS: GameEvent[] = [
  ...
  sea('ody_a3_bow_watch', 3, {
    ...
    right: {
      ...
      incredible: 'Doubled watch, plain word — and you pair the bow watch with the oldest bench for the night shifts, friends, the rower who reads water by feel through the hull timbers, and it is he who solves it with his palm flat on the bow planks: a rhythm under the wave, regular as rowing. Not the sea watching. The sea COUNTING — matching the fleet’s stroke, learning it. You change the stroke pattern at the next dawn, syncopated, a beat no water expects, and the wave loses the count and dissolves. The old rower laughs — a sound the benches cannot place, friends, having no memory of the last one. The sea, outsung by a man with his hand on a plank.',
    },
  }),
