...
export const ACT2_EVENTS: GameEvent[] = [
  ...
  sea('ody_a2_circe_road', 2, {
    ...
    right: {
      ...
      good: 'The underworld leg only, learned cold and complete, the rest deferred: a man can hold one abyss in his head properly or five badly, and you have men to steer past the one. She approves — witches respect economy — and promises the next briefing at your return. You sail for the world’s edge carrying exactly as much fear as needed. Fear, friends, is ballast: the trim matters more than the tonnage.',
  ...
  sea('ody_a2_pigs_memory', 2, {
    ...
    left: {
      ...
      bad: 'You open the door to the talk and the talk goes where you cannot steer it: past the sty, past the witch, into the wider question of what ELSE this voyage has made of them — and the fire goes late and dark, and some things get said between benches that need a month to heal. Truth, friends, is medicine. Dosage is everything.',
    ...
    right: {
      ...
      bad: 'You prescribe work, the old cure, and work works — on the surface, friends, where work lives. Underneath, the restfulness of the sty stays sweet in the memory, unexamined and waiting, and on the bad nights ahead more than one man will find his thoughts trotting back to the mud where nothing was asked of him. A cure that only tires the patient, friends, is a lullaby.',
